          ...
          <div className="space-y-3">
            {teachersMonthlyQuery.isLoading ? (
              ...
              filteredTeachers.map((t, i) => {
                ...
                return (
                  <div key={`${teacherId}-${i}`} className="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${salaryStatusStyle(t?.is_closed)}`}>
                    ...
                    {isDetailsOpen && (
                      <div className="border-t border-gray-200 px-4 pb-4 pt-4">
                        <p className="mb-3 text-base font-semibold text-gray-900">Qisqa ma'lumot</p>
                            ...
                            {openPercentByTeacher[teacherId] && (
                              <div className="mt-2 flex items-center gap-2">
                                <input
                                  ...
                                  placeholder="Foiz"
                                  className="w-24 rounded-lg border border-gray-300 px-2 py-1 text-sm outline-none focus:ring-2 focus:ring-[#A60E07]/20"
                                />
                                <button
                            ...
                            {openAdvanceByTeacher[teacherId] && (
                              <div className="mt-2 flex items-center gap-2">
                                <input
                                  ...
                                  className="w-32 rounded-lg border border-gray-300 px-2 py-1 text-sm outline-none focus:ring-2 focus:ring-[#A60E07]/20"
                                />
                                <button
                        ...
                        <p className="mt-6 mb-3 text-base font-semibold text-gray-900">Amallar</p>
                          ...
                          <div className="rounded-2xl border border-gray-200 p-4">
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <button
                                ...
                                className="shrink-0 rounded-lg bg-emerald-100 px-3 py-2 text-sm font-semibold text-emerald-700 disabled:opacity-50"
                              >
                                Oylikni yopish
                              </button>
                            </div>
                        ...
                        <div className="mt-4 rounded-2xl border border-gray-200 bg-gray-50 p-3">
                          <button
                            ...
                            className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700"
                          >
