...
const getStudentStatusBadge = (status) => {
    ...
    if (status === 'finished') return 'bg-blue-100 text-blue-800';
...
// Faqat ko'rish uchun guruh detail sahifasi — talaba qo'shish/chiqarish/o'chirish yo'q.
const EnglishManagerGroupDetailPage = () => {
    ...
    return (
        <div className="min-h-full p-1.5 sm:p-4 bg-gray-50">
            <div className="mb-2.5 sm:mb-4">
                <Link href="/english-manager/groups" className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-600 hover:text-[#A60E07]">
...
export default EnglishManagerGroupDetailPage;
